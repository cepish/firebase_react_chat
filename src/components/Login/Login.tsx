        ...
        <div className={css.container}>
            <div className={css.outerHolder}>
                <div className={css.innerHolder}>
                    ...
                    <h4 className={css.header}>Nice to meet you again! Please, sign in to start chating.</h4>
                    <form id="signInForm" onSubmit={handleSubmit}>
                        <div className={css.formContainer}>
                            ...
                            <input type="submit" className="btn btn-submit" value="Sign in with Google"/>
                        </div>
                        <span className={css.loginError}>{loginError ? loginError.toString() : null}</span>
                    </form>
                </div>
            </div>
        </div>   
